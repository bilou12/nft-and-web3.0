...
it('can add the star name and star symbol properly', async () => {
    ...
    let nftName = await instance.name();
    let nftSymbol = await instance.symbol();

    assert.equal(nftName, 'Ben zaza');
    assert.equal(nftSymbol, 'BZA');
});
...
it('lets 2 users exchange stars', async () => {
    ...
    await instance.createStar('Star Name 8', starId1, {
        from: user1
    });
    await instance.createStar('Star Name 9', starId2, {
        from: user2
    });
